...
const NewsLetter = () => {
  const titleTexts = {
    title: "Stay Inspired",
    desc: "Join our newsletter and be the first to discover new destinations, exclusive offers, and travel inspiration.",
  };
  return (
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
        ...
        <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">
          ...
          <img
            ...
            alt="arrow-icon"
            className="w-3.5 invert group-hover:translate-x-1
      transition-all"
          />
        </button>
      </div>
